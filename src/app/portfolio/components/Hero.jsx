...
export default function Hero() {
  return (
    <section className="relatve w-full h-[calc(100vh-60px)]">
      ...
      <div className="relative z-10 w-full h-full flex flex-col items-start justify-center px-8 lg:px-20 text-white ">
        <h2 className="font-bold text-2xl lg:text-4xl mb-6">Our Work Speaks for itself</h2>

        <p className="font-regular text-[#AEAEAE] text-lg lg:text-2xl leading-relaxed">
