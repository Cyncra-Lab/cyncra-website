...
export default function Hero() {
  return (
    <section className="text-white w-full h-[calc(100vh-60px)] flex items-center justify-start py-0 lg:py-11 bg-gradient-to-b from-[#023b43] to-[#0595a9]">
      <div className="text-center w-full px-5 lg:px-20 mx-auto">
        <div className="flex flex-col items-center gap-[72px]">
          {/* Text Section */}
          <div className="w-full h-auto lg:h-[236px] flex flex-col justify-center">
            <h3 className="lg:mb-4 mb-1 text-2xl lg:text-5xl font-bold tracking-wide">
              ABOUT US
            </h3>
            <h2 className="font-bold text-lg lg:text-4xl mb-6">
