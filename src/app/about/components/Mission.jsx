  ...
  return (
    <section className="bg-[rgb(230,250,252)] min-h-screen pt-11 text-[#0C120C] flex justify-center">
      <div className="w-full px-5 lg:px-20 mx-auto">
        <h2 className="text-center lg:text-3xl text-2xl font-bold lg:mb-15 mb-5">
          Who We Are
        </h2>
        <div>
        ...
        <div className="flex flex-col lg:flex-row items-center gap-6 lg:gap-14">
          <div className="flex flex-col lg:gap-6 lg:w-[34.0625rem] lg:h-[21.875rem]">
            ...
            <p className="text-base lg:text-2xl text-[#727272]">
              Our work is intentional and beautiful. Every pixel, every layout,
              every interaction crafted to inspire and engage.
            </p>
          </div>
          <div className="flex flex-col lg:gap-6 lg:w-[34.0625rem] lg:h-[21.875rem]">
            <span className="text-2xl lg:text-6xl font-bold text-[#C0BFBF] mb-4">
            ...
            <p className="text-base lg:text-2xl text-[#727272]">
              We focus on solving real problems, not just ticking feature boxes.
              If it doesn’t bring value, it doesn’t make the cut.
            </p>
          </div>
          <div className="flex flex-col lg:gap-6 lg:w-[34.0625rem] lg:h-[21.875rem]">
            <span className="text-2xl lg:text-6xl font-bold text-[#C0BFBF] mb-4">
            ...
            <p className="text-base lg:text-2xl text-[#727272]">
              From strategy to launch, we ensure every product we deliver drives
              measurable growth and meaningful results.
            </p>
          </div>
        </div>
      </div>
